...
class _addAnnonceState extends State<addAnnoncePage> {
  ...
  var typeAnnonceOptions = ['Lost', 'Found'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          centerTitle: true,
          title: Text("Add new Annonce",style: TextStyle(
              fontSize: 16.0,
